...
<body>
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h5 class="signup-heading">Sign up and get your nid</h5>
                </div>
            </div>
            ...
            <div class="row my-3 py-5 justify-content-center">
                <div class="col-10 col-sm-5 form_input">
                    <form action="">
                        ...
                        <input type="text" class="myinput" placeholder="Email">
                        <input type="text" class="myinput" placeholder="Password">

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">
                                I agree with the Term Of Services, Privacy Policy, Acceptable Use Policy,
